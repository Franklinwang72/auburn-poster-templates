# poster-research-terminal

<a href="../previews/hd/poster-research-terminal.jpg"><img src="../previews/hd/poster-research-terminal.jpg" width="100%"></a>

<p align="center"><a href="https://github.com/Franklinwang72/auburn-poster-templates/releases/latest/download/poster-research-terminal.zip"><img alt="Download ZIP" src="https://img.shields.io/badge/Download-ZIP-2da44e?style=for-the-badge" /></a></p>
...
`poster-research-terminal.tex` is only your content — all styling lives in `postertheme.sty`.
...
> Fira Sans runs wider than Source Sans (body 23.9/31.9, `\BodyH` 48.5 cm). Figures are dark-ground variants; the QR sits on a white card so it scans.
